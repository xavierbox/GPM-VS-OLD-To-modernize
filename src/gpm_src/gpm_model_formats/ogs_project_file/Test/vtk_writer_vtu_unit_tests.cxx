...
int Test_vtu_configs(int argc, char* argv[])
{
    ...
    const auto res1 = Slb::Exploration::Gpm::vtk_writer_vtu::check_cell_pointers(test, bottom, top_mapped, false);
	...
	map_to_prev[5] = 1;
	std::transform(top.begin(), top.end(), top_mapped.begin(), transfer_func);
	const auto res2 = Slb::Exploration::Gpm::vtk_writer_vtu::check_cell_pointers(test, bottom, top_mapped, false);
	...
	map_to_prev[6] = 2;
	std::transform(top.begin(), top.end(), top_mapped.begin(), transfer_func);
	const auto res3 = Slb::Exploration::Gpm::vtk_writer_vtu::check_cell_pointers(test, bottom, top_mapped, false);
	...
	map_to_prev[7] = 3;
	std::transform(top.begin(), top.end(), top_mapped.begin(), transfer_func);
	auto res4 = Slb::Exploration::Gpm::vtk_writer_vtu::check_cell_pointers(test, bottom, top_mapped, false);
